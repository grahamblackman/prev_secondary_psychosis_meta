...
1. [meta_sec_psy_master.R](https://github.com/grahamblackman/prev_secondary_psychosis_meta/blob/main/meta_sec_psy_master.R) - the master script that calls other scripts in order to reproduce the results reported in the manuscript
